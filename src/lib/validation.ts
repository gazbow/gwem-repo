...
import { allBudgetOptions } from "@/data/config";
...
export const submitSchema = z.object({
  ...
  // Optional budget: must be one of the known bands (any tier), or empty.
  budget: z.enum(allBudgetOptions).optional().or(z.literal("")),
